    ...
    return (
      <div className="space-y-8 text-black md:max-w-[1536px] md:mx-auto ">
        ...
        <section className="p-4 flex flex-col gap-1 justify-center items-center">
          <h2 className="text-3xl sm:text-4xl md:text-[2.4rem] font-semibold mb-2">Fashion</h2>
          <p className="text-lg sm:text-[1.2rem] font-normal opacity-60 text-center">
          Stay in style with the latest trends in clothing, shoes, watches, and fashion accessories for all.
          </p>
          <p className="font-normal text-sm sm:text-base opacity-60 mb-[3%]">{fashionProducts.length} Products Found</p>
