    ...
    return (
      <div className="space-y-8 text-black md:max-w-[1536px] md:mx-auto ">
        ...
        <section className="p-4 flex flex-col gap-1 justify-center items-center">
          <h2 className="text-3xl sm:text-4xl md:text-[2.4rem] font-semibold mb-2">Beauty</h2>
          <p className="text-lg sm:text-[1.2rem] font-normal opacity-60 text-center">
          Glow up with premium skincare, cosmetics, and fragrances from top beauty brands.
          </p>
          <p className="font-normal text-sm sm:text-base opacity-60 mb-[3%]">{beautyProducts.length} Products Found</p>

          <div className="flex flex-col w-full md:flex-row md:items-center gap-1 md:justify-end md:gap-2">
            <label className="text-base font-normal opacity-60 flex flex-row gap-1 items-center"><span><FiSettings/></span>Sort By: </label>
            <select
        ...
        <div className="hidden lg:flex flex-col gap-6 px-6 py-4 rounded w-[43%] max-w-[368px] max-h-[240px] shadow-md -translate-y-15 sticky top-[80px]  bg-white">
