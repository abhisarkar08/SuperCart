        ...
        <div className='w-full px-8 py-16'> {/* Full width with more padding */}
            <div className='grid grid-cols-1 md:grid-cols-4 gap-12'>
                ...
                <div className='space-y-6'>
                    <h1 className='text-white text-2xl font-semibold'>PixelCart</h1>
                    <p className='text-base text-gray-400 leading-relaxed'>
                        PixelCart brings you a curated collection of quality essentials — delivered with unmatched service, speed, and style.
                    </p>
                ...
                <div>
                    ...
                    <div className='space-y-5'>
                        <div className='flex items-center space-x-4'>
                            ...
                            <p className='text-gray-400 text-base'>1-800-SHOP-NOW</p>
                        </div>
                        <div className='flex items-center space-x-4'>
                            <div className='w-6 h-6 flex items-center justify-center'>
                                <FaEnvelope className='text-gray-400 text-sm'/>
                            </div>
                            <p className='text-gray-400 text-base'>support@pixelcart.com</p>
                        </div>
                        <div className='flex items-start space-x-4'>
                            <div className='w-6 h-6 flex items-center justify-center mt-1'>
                                <FaMapMarkerAlt className='text-gray-400 text-sm'/>
                            </div>
                            <p className='text-gray-400 text-base'>123 Commerce St, City, State 12345</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='border-t border-gray-800 mt-16 pt-10'>
                <div className='text-center'>
                    <p className='text-gray-500 text-base'>© 2025 PixelCart. All rights reserved. | Privacy Policy | Terms of Service</p>
                </div>
            </div>
        </div>
    </div>
